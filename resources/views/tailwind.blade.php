    ...
    <header class="bg-slate-50 shadow-sm">
        <div class="flex align-center sm:justify-normal justify-between sm:max-w-3xl m:max-w-4xl ml:max-w-5xl l:max-w-6xl m-auto text-gray-800/80 text-m">
            ...
            <div class="hidden sm:flex">
                ...
                <a href="#websites" class="hover:scale-105 duration-100 ml-2 self-end px-4 py-4 border-b-2 border-slate-400/0 hover:bg-slate-100 hover:border-blue-500 hover:text-gray-800">Websites</a>
            ...
            <a class="my-auto" href="#account"><img class="h-6 my-auto" src="https://cdn-icons-png.freepik.com/256/1144/1144760.png"></a>

        </div>
    </header>
{{--Main--}}
    <main class="my-16">
        <div class="flex justify-between m-auto sm:max-w-3xl m:max-w-4xl ml:max-w-5xl l:max-w-6xl text-3xl mb-5 text-gray-800/95">
            <h1>Webshop</h1>
            <h1>T-Shirts</h1>
        </div>
        <div class="grid grid-cols-3 m-auto gap-10 sm:max-w-3xl m:max-w-4xl ml:max-w-5xl l:max-w-6xl">
            @for ($x = 0; $x <= 29; $x++)
                <div>
                    <div class="aspect-[5/6] bg-green-600 rounded"></div>
                    <div class="m-auto pt-2 pb-0.5 flex justify-between align-center">
                        <p class="text-gray-800/95">Sweater</p>
                        <p class="text-gray-800/95">40,00$</p>
                    </div>
                    <p class="text-xs text-gray-800/80">Charcoal</p>
                </div>
            @endfor
        </div>
    </main>
